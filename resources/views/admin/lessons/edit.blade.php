    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lessons.update", [$lesson->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $lesson->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_link') ? 'is-invalid' : '' }}" type="text" name="video_link" id="video_link" value="{{ old('video_link', $lesson->video_link) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('free_lesson') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="free_lesson" id="free_lesson" value="1" {{ $lesson->free_lesson || old('free_lesson', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="free_lesson">{{ trans('cruds.lesson.fields.free_lesson') }}</label>
                </div>
