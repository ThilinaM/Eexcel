...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses.update", [$course->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="cover">{{ trans('cruds.course.fields.cover') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.course.fields.cover_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" type="text" name="price" id="price" value="{{ old('price', $course->price) }}">
              @if($errors->has('price'))
                  <div class="invalid-feedback">
                      {{ $errors->first('price') }}
                  </div>
          ...
          <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('link_text') ? 'is-invalid' : '' }}" type="text" name="link_text" id="link_text" value="{{ old('link_text', $course->link_text) }}">
            @if($errors->has('link_text'))
                <div class="invalid-feedback">
                    {{ $errors->first('link_text') }}
                </div>
            @endif
            <span class="help-block">{{ trans('cruds.course.fields.link_text_helper') }}</span>
        </div>
        <div class="form-group">
...
@if(isset($course) && $course->cover)
      var file = {!! json_encode($course->cover) !!}
